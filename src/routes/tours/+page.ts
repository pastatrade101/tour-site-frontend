...
import type { Destination, FAQ, Review, ReviewSummary, Tour } from '$lib/types';
...
export const load: PageLoad = async ({ fetch }) => {
  const [tours, destinations, reviews, reviewSummary, faqs, gallery] = await Promise.allSettled([
